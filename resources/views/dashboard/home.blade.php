                    ...
                    <div class="tab-pane active show fade" id="activity_all">
                            ...
                            <div class="flex">
                                <div class="d-flex align-items-middle">
                                    <div class="avatar avatar-xxs mr-1">
                                        <img src="backend/assets/images/256_rsz_1andy-lee-642320-unsplash.jpg" alt="Avatar" class="avatar-img rounded-circle">
                                    </div>
                        ...
                        <div class="list-group-item list-group-item-action d-flex align-items-center ">
                            ...
                            <div class="flex">
                                <div class="d-flex align-items-middle">
                                    <div class="avatar avatar-xxs mr-1">
                                        <img src="backend/assets/images/256_daniel-gaffey-1060698-unsplash.jpg" alt="Avatar" class="avatar-img rounded-circle">
                                    </div>
                        ...
                        <div class="list-group-item list-group-item-action d-flex align-items-center  bg-light ">
                            ...
                            <div class="flex">
                                <div class="d-flex align-items-middle">
                                    <div class="avatar avatar-xxs mr-1">
                                        <img src="backend/assets/images/256_jeremy-banks-798787-unsplash.jpg" alt="Avatar" class="avatar-img rounded-circle">
                                    </div>
                        ...
                        <div class="list-group-item list-group-item-action d-flex align-items-center  bg-light ">
                            ...
                            <div class="flex">
                                <div class="d-flex align-items-middle">
                                    <div class="avatar avatar-xxs mr-1">
                                        <img src="backend/assets/images/256_joao-silas-636453-unsplash.jpg" alt="Avatar" class="avatar-img rounded-circle">
                                    </div>
                        ...
                        <div class="list-group-item list-group-item-action d-flex align-items-center  bg-light ">
                            ...
                            <div class="flex">
                                <div class="d-flex align-items-middle">
                                    <div class="avatar avatar-xxs mr-1">
                                        <img src="backend/assets/images/256_luke-porter-261779-unsplash.jpg" alt="Avatar" class="avatar-img rounded-circle">
                                    </div>
                    ...
                    <div class="tab-pane" id="activity_purchases">
                        ...
                        <div class="list-group-item list-group-item-action d-flex align-items-center  bg-light ">
                            ...
                            <div class="flex">
                                <div class="d-flex align-items-middle">
                                    <div class="avatar avatar-xxs mr-1">
                                        <img src="backend/assets/images/256_michael-dam-258165-unsplash.jpg" alt="Avatar" class="avatar-img rounded-circle">
                                    </div>
                ...
                <tbody class="list" id="staff">
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <div class="media align-items-center">
                                <img src="backend/assets/images/avatar/green.svg" class="mr-2" alt="avatar" />
                                <div class="media-body">
